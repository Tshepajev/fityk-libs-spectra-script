...
input_path="/Users/jasper/repos/fityk-libs-spectra-script/Examples/656nm_H+Mo_example_66_lines/Input/"
output_path="/Users/jasper/repos/fityk-libs-spectra-script/Examples/656nm_H+Mo_example_66_lines/Output/"
...
if is387 then nr_of_lines=1 -- deleted most for this example
else nr_of_lines=66 end
...
if is387 then
  ...
  -- This is copied from an older script so it isn't so well formatted 
  -- nor calibrated as the other examples.
  973,  --1  I  -- H-line
  420.7,  --2  O
  437.7,  --3  O
  452,	--4
